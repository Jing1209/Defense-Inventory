                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9 right-0">
                                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add Sponosr</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                @enderror
                                                <input type="text" id="fsponsorName" name="sponsor_name" value="{{ $sponsor->sponsor_name }}"
