<!-- Sidebar scroll-->
<div class="scroll-sidebar sticky-top" data-sidebarbg="skin6">
    <!-- Sidebar navigation-->
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            ...
            <li class="nav-small-cap"><span class="hide-menu">All Menu</span></li>
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('employees.index') }}"
                    aria-expanded="false"><i data-feather="user" class="feather-icon"></i><span
                        class="hide-menu">Employee</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('sponsors.index') }}"
                    aria-expanded="false"><i data-feather="users" class="feather-icon"></i><span
                        class="hide-menu">Sponsor</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('buildings.index') }}"
                    aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                        class="hide-menu">Buildings</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('rooms.index') }}"
                    aria-expanded="false"><i data-feather="copy" class="feather-icon"></i><span
                        class="hide-menu">Rooms</span></a></li>
            ...
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('items.index') }}"
                    aria-expanded="false"><i data-feather="inbox" class="feather-icon"></i><span
                        class="hide-menu">Items</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('transactions.index') }}"
            ...
            <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                ...
                <ul aria-expanded="false" class="collapse  first-level base-level-line">
                    <li class="sidebar-item"><a href="{{ route('settings.index')}}" class="sidebar-link"><span class="hide-menu">
                                View Profile
                            </span></a>
                    </li>
                    <li class="sidebar-item"><a href="{{ route('settings.edit',auth()->user()->id)}}" class="sidebar-link"><span
                                class="hide-menu"> Update Profile
                            </span></a>
                    </li>
                    <li class="sidebar-item"><a href="{{ route('logout') }}"
                        onclick="event.preventDefault();
                        document.getElementById('frm-logout').submit();" class="sidebar-link"><span
