<div class="navbar-header stricky-top" data-logobg="skin6">
    ...
    <div class="navbar-brand mt-3">
        ...
        <a href="/home">
            <b class="logo-icon">
                <!-- Light Logo icon -->
                <img src="{{asset('assets/images/logo-icon.png')}}" alt="homepage" width="90px" height="90px" class="dark-logo mx-5" />
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
        </a>
...
<div class="navbar-collapse collapse" id="navbarSupportedContent">
    ...
    <!-- ============================================================== -->
    <ul class="navbar-nav float-left mr-auto ml-3 pl-1"> <span class="logo-text">
            <h3>Institute of Technology of Cambodia</h3>
        </span></ul>
    ...
    <ul class="navbar-nav float-right">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="{{asset('assets/images/img2.jpg')}}" alt="user" class="rounded-circle" width="40">
                @if (Auth::user())
                    <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark">{{Auth()->user()->name}}</span> </span>
                @endif
            </a>
