                                                ...
                                                <div class="col-md-12 mb-4">
                                                    <div class="form-outline">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" name="condition" type="radio"
                                                                id="Good" value="Good" checked />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" name="condition"
                                                                type="radio" id="Bad" value="Bad" />
                                                            <label class="form-check-label" for="Bad">Bad</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" name="condition"
                                                                type="radio" id="Broken" value="Broken" />
                                                ...
                                                <div class="col-md-12 mb-4">
                                                    <div class="form-outline">
                                                        ...
                                                        <label class="form-label" for="itemName"><b
                                                            ...
                                                            Price</label>
                                                        <input type="number" id="fitemName" name="price"
                                            ...
                                            <div class="form-outline">
                                                <div class="row">
                                                    <div class="border text-center">
                                                        ...
                                                        <img id="output" width="350px" height="350px"
                                                            src="{{ asset('assets/images/border.jpg') }}" />
                                                    </div>
                                                    <div class="d-flex my-3">
                                                        <input type="file" name="image" id="actual-btn"
                                                            onchange="loadFile(event)" hidden>
                                                        <label style="cursor: pointer;"
                                                            class="bg-success text-white p-2 rounded text-center"
                                                            for="actual-btn">Choose File</label>
                                                        <div id="file-chosen" class="py-2 ps-2" style="width: 400px;">No
                                                            file chosen</div>
                                                    </div>
                                                    @error('image')
                                                        <span class="invalid-feedback text-danger" role="alert">
