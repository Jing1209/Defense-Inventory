                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-dark active" aria-current="page">Add Room</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9 right-0">
                                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add Room</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                @enderror
                                                <input type="text" id="froomName" name="room_name"
